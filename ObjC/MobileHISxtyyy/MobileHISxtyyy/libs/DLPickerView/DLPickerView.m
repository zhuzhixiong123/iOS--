...
- (void)initPickerHeaderView {
    ...
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, ConfirmButtonHieght)];
    bgView.backgroundColor = RGBACOLOR(0, 146, 252, 1);
    [self.pickerBackView addSubview:bgView];
    
    UILabel *titleLb = [[UILabel alloc] initWithFrame:CGRectMake(ConfirmButtonWeight, ConfirmButtonPointY, Screen_W-ConfirmButtonWeight*2, ConfirmButtonHieght)];
    titleLb.text = @"请选择服务时间";
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    text =  [NSString stringWithFormat:@"%@", self.dataSource[component]];
